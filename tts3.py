...
def trans():
    ...
    for i in range(len(List_key)):
        ...
        else : print("language Unavailable")
...
image_icon = PhotoImage(file="translater.png")
...
Logo = PhotoImage(file="translater.png")
...
# translate combobox
imageicon4 = PhotoImage(file="translate.png")
